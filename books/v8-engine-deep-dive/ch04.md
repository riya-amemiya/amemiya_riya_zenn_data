---
title: "第3章 Map (Hidden Class) と Transition Tree"
free: true
---
...
Map と Transition Tree、DescriptorArray、PropertyDetails、Representation、Map Stability を解剖しました。次章では、その Map を Hidden Class として持つ実際のオブジェクト — JSObject — のレイアウト、In-object Properties、PropertyArray、Slow Properties (Dictionary Mode)、SwissNameDictionary を扱います。
