---
title: "Array.prototype.flat 完全解説"
free: true
---
...
第1章から第4章までで導入した語彙 (Tagged Pointer、ElementsKind、FastJSArrayWitness、Torque) が、ひとつの builtin の中でどのように組み合わさるかを観察するケーススタディとして読めます。
