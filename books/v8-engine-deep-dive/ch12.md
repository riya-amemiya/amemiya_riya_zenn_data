---
title: "第11章 実行パイプライン Ignition / Sparkplug / Maglev / TurboFan"
free: true
---
...
実行パイプラインを見ました。次章では JIT に最適化情報を渡す機構 — Inline Cache、FeedbackVector、LoadHandler / StoreHandler、Polymorphic から Megamorphic への遷移、Deoptimization、Code オブジェクトの構造を扱います。これが第 I 部 V8 基礎の最終章です。
