---
title: "第2章 HeapObject と Object 階層"
free: true
---
...
HeapObject の構造と Object 階層、Handle / DirectHandle / MaybeHandle を扱いました。次章では、HeapObject の先頭バイトが指す Hidden Class — Map — そのものに焦点を当て、Transition Tree、DescriptorArray、PropertyDetails の全貌を扱います。
