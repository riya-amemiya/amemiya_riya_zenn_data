---
title: "第5章 ElementsKind 完全列挙と遷移"
free: true
---
...
ElementsKind による配列の物理表現を見ました。次章では文字列の世界に移り、SeqString / ConsString / SlicedString / ThinString / ExternalString の 5 階層、Flatten、Internalization と String Table、String Hash の計算を扱います。
