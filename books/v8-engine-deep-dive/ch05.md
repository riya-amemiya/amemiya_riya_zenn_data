---
title: "第4章 JSObject のレイアウトと Properties / Elements"
free: true
---
...
JSObject の Properties レイアウトを扱いました。次章では JSObject のもう一方の格納領域 — Elements — に焦点を当て、ElementsKind の 21 種類の完全列挙、PACKED と HOLEY の対称軸、SMI / DOUBLE / Tagged の三本軸、遷移の単方向性、holey 化のトリガを扱います。
