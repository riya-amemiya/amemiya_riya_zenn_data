---
title: "第10章 Orinoco GC - Scavenger と Mark-Compact"
free: true
---
...
GC を解剖しました。次章では JIT パイプライン — Ignition Bytecode Interpreter、Sparkplug Baseline JIT、Maglev Mid-tier Optimizing Compiler、TurboFan Top-tier、Turboshaft 後段、Sea of Nodes、Escape Analysis、Bounds Check Elimination を扱います。
