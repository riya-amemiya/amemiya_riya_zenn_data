---
title: "第8章 Pointer Compression Cage と V8 Sandbox"
free: true
---
...
Pointer Compression と V8 Sandbox を解剖しました。次章ではこれらの上に積み上がる Heap の物理レイアウト — NewSpace / OldSpace / CodeSpace / RO Space / LargeObjectSpace、Page と MemoryChunk の分離、FreeList、Allocation Site と Pretenuring を扱います。
