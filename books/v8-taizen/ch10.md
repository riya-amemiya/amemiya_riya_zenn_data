---
title: "第9章 Heap Spaces とメモリレイアウト"
free: true
---
...
Heap Spaces を見ました。次章ではこのヒープ上で動作するガベージコレクタ — Orinoco — の Scavenger (Cheney's Algorithm)、Mark-Compact、Concurrent Marking、Incremental Marking、Conservative Stack Scanning、FinalizationRegistry を扱います。
