...
| --- | ---: | ---: | ---: |
| packed smi miss `-1` | 0.0762 | 0.0574 | 約1.3x |
| packed smi miss `1.5` | 0.1275 | 0.0567 | 約2.3x |
| packed smi miss `'x'` | 0.1017 | 0.0756 | 約1.3x |
| packed smi hit start | 0.0765 | 0.0575 | 約1.3x |
| packed double miss `-1.25` | 0.1421 | 0.0565 | 約2.5x |
| packed double miss `'x'` | 0.1544 | 0.000006 | 約26000x |
| packed double miss `NaN` | 0.1439 | 0.000007 | 約21000x |
| packed double miss `undefined` | 0.1696 | 0.0526 | 約3.2x |
| packed double hit start | 0.1797 | 0.0580 | 約3.1x |
| packed object miss | 0.1278 | 0.1267 | 約1.0x |
| holey smi miss `-1` | 0.0764 | 0.0561 | 約1.4x |
| holey double miss `-1.25` | 0.1595 | 0.0560 | 約2.8x |
| holey double miss `'x'` | 0.1535 | 0.000006 | 約26000x |
...
| packed object miss | 0.1278 ms/op | 0.1267 ms/op | 約1.0x(今回のパッチでは触れていない) |
