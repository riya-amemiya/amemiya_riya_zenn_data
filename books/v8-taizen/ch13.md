---
title: "第12章 Inline Cache, Type Feedback, FeedbackVector"
free: true
---
...
第 I 部 V8 基礎の 12 章を駆け抜けました。Tagged Pointer から Inline Cache まで V8 の全レイヤを一周しました。第 II 部ではこの基礎をメモリ管理という縦軸で再俯瞰し、第 I 部とは異なる視点で同じ概念を再度解剖します。次章 (ch14) ではメモリ管理深掘り 第I部 オブジェクト表現とタグ付きポインタを扱います。
