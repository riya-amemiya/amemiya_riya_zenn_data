...
| --- | ---: | ---: | ---: | --- |
| `smi_fill_full` | 34.67 us/op | 5.07 us/op | 6.8x | −85% |
| `smi_fill_partial` | 30.46 us/op | 4.53 us/op | 6.7x | −85% |
| `holey_smi_fill_full` | 36.46 us/op | 4.96 us/op | 7.4x | −86% |
| `double_fill_full` | 51.37 us/op | 10.10 us/op | 5.1x | −80% |
| `double_fill_partial` | 45.85 us/op | 9.01 us/op | 5.1x | −80% |
| `double_fill_1M` | 514.6 us/op | 99.9 us/op | 5.2x | −81% |
| `smi_fill_small_n16` | 0.020 us/op | 0.015 us/op | 1.3x | ノイズ域（呼び出し固定費が支配） |
| `object_fill_full` | 55.6 us/op | 66.4 us/op | 0.84x | ほぼ横ばい（ばらつき大、最適化対象外） |
